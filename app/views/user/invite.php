                ...
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row gap-4">
                        <input type="text" value="<?= \App\Core\View::url('auth/register?ref=' . ($user['referral_code'] ?? '')) ?>" 
                               class="flex-1 px-4 py-2 border border-gray-300 rounded-none bg-gray-50" readonly id="referralLink">
                        <button onclick="copyReferralLink()" class="px-6 py-2 bg-accent text-white rounded-none font-medium">
                            Copy Link
                        </button>
                    </div>
