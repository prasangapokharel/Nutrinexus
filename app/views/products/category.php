...
<div class="container mx-auto px-4 py-8 md:py-12">
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 border-b border-gray-200 pb-4">
        <h1 class="text-2xl md:text-3xl font-bold text-primary mb-4 md:mb-0"><?= htmlspecialchars($category) ?> Products</h1>
                ...
                <div class="bg-white border border-gray-100 group">
                    <div class="relative">
                        ...
                        <button type="button" 
                                ...
                                data-product-category="<?= htmlspecialchars($product['category'] ?? $category) ?>"
